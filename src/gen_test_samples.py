...
def load_keywords():
    return {
        ...
        "TRIEU_CHUNG": [
            ...
            "li bì", "lú lẫn", "choáng", "ngất", "hạ huyết áp", "tăng huyết áp",
            # Hô hấp
            ...
            # Tiết niệu / sản khoa
            "đái buốt", "đái dắt", "tiểu máu", "tiểu đêm", "bí tiểu",
        ...
        "BENH": [
            ...
            "viêm bao gân", "lupus", "lupus ban đỏ hệ thống",
            # Tiêu hóa / gan mật
        ...
        "THUOC": [
            ...
            "Isosorbide", "Atorvastatin", "Rosuvastatin", "Simvastatin",
            # Tiểu đường / nội tiết
