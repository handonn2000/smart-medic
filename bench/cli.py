...
DEFAULT_CORPORA = [
    ...
    "gen/synthetic:data/gen/synthetic:data/generated_medical_records/synthetic/text",
    "gen/translated:data/gen/translated:data/generated_medical_records/translated/text",
    "gen/restyled:data/gen/restyled:data/generated_medical_records/restyled/text",
]
...
DEFAULT_GOLDS = [
    "data/gold_variants/consensus",
    "data/gold_variants/sonnet5",
    "data/gold_variants/opus5",
    "data/gold_variants/prefill",
]
