...
`data/generated_medical_records/` có 372 tài liệu gán nhãn từ
...
| `gen/restyled` | 83 | 2.540 | **−1,20** ❌ | 9,9% ✅ | 11% ❌ |

**0 lỗi offset trên cả 11.261 span** — kiến trúc "code chọn thực thể trước, LLM
...
Bốn biến thể nằm ở `data/dev_gold_{consensus,sonnet5,opus5,prefill}/`; `bench robust` dùng chúng làm mặc định.
